  ...
  return (
    <section className="relative min-h-[65vh] gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-20 -left-20 w-80 h-80 bg-secondary/10 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-10 right-1/4 w-64 h-64 bg-success/10 rounded-full blur-3xl animate-float"
      ...
      <div className="relative z-10 px-6 py-16 md:py-20 max-w-4xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 backdrop-blur-sm border border-primary/20 mb-6 animate-fade-slide-up">
        ...
        >
          Get your HS/TARIC code + audit-ready legal defense memo in seconds. No
          more guessing or expensive consultants.
        </p>
